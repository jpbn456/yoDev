/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0ca2a37cc3bbd4ea0c8662934713b25a)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	CORS_ORIGIN: "http://localhost:5173,https://yodev-api.primera-fila-s.workers.dev";
	RATE_AUTH_MAX: "10";
	APP_ORIGIN: "https://yodev-api.primera-fila-s.workers.dev";
	EMAIL_FROM: "yoDev <onboarding@resend.dev>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "RATE_AUTH_MAX" | "APP_ORIGIN" | "EMAIL_FROM" | "RESEND_API_KEY">> {}
}
